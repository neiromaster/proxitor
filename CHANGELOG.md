...
- b7a49ce: Observability sink colors now use Node's built-in `util.styleText`.
...
- 136930c: New cache observability for proxied requests. Each request now logs a cache
